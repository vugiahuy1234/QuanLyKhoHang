...
namespace QuanLyKhoHang.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\source\repos\QuanLyKhoHang\QuanLyBanHang.mdf;Integrated Security=True;Connect Timeout=30";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
